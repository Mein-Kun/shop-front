...
const CatalogItem = ({ item }: { item: IAvtoPart }) => {
  ...
  // const isInFavorite = shoppingCart.some(
  //   (cartItem) => cartItem.partId === favorite.id
  // )
  ...
  return (
    <li className={`${styles.catalog__list__item} ${darkModeClass}`}>
      ...
      <div className={styles.catalog__list__item__inner}>
        ...
        {/* <span
          className={styles.catalog__list__item__favorite}
          onClick={updateFavorite}
        >
          {item.id === favorite.partId ? <FavoriteSvgOn /> : <FavoriteSvgOff />}
        </span> */}
